...
def build_database(repo_path):
    ...
    for filepath in root.glob("*/*.md"):
        ...
        slug = filepath.stem
        url = "https://github.com/jcdiv47/til/blob/main/{}".format(path)
        ...
        if (body != previous_body) or not previous_html:
            ...
            while retries < 3:
                ...
                response = httpx.post(
                    ...
                    json={
                        # gfm mode is needed for > [!NOTE] style alerts. Passing
                        # no "context" keeps #13 from expanding to issue links
                        "mode": "gfm",
                        "text": body,
                    },
                    headers=headers,
